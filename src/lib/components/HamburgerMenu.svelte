...
<!-- Drawer -->
<div
	class="fixed bottom-0 left-0 right-0 z-50 rounded-t-3xl transition-transform duration-300"
...
>
	...
	<nav class="px-4 pb-4 space-y-1">
		...
		>
			...
			<span class="font-medium text-sm" style="color: var(--color-on-surface)">Listen</span>
		</button>
		...
		{#if user?.role === 'admin'}
			...
			>
				...
				<span class="font-medium text-sm" style="color: var(--color-on-surface)">Benutzer</span>
			</button>
		{/if}
		...
		>
			...
			<span class="font-medium text-sm" style="color: var(--color-on-surface)">Einstellungen</span>
		</button>
		...
		>
			...
			<span class="font-medium text-sm" style="color: var(--color-error)">Abmelden</span>
		</button>
	</nav>
